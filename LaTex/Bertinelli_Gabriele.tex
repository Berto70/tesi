...
La possibilità di rilevare un'intensità dipende dall'abbondanza della particolare specie, in modo che la forza dell'intensità possa essere rilevata sopra il rumore dello spettro.\\
...
\begin{figure}[!h]
\centering
	{\includegraphics[width=.5\textwidth]{figure/primo_contatto.jpg}} \\
	\vspace{0.5cm}
	{\includegraphics[width=.3\textwidth]{figure/920.png}} \quad
	{\includegraphics[width=.3\textwidth]{figure/penultima_dart.png}}
\caption{Partendo dall'alto in senso antiorario: primo contatto di DART con il sistema di Didymos; immagine del sistema a 920 m; penultima immagine prima dello scontro. (NASA/JHU-JPL)}
\label{fig:subfig}
\end{figure}

\subsection{Campagna di osservazioni}
L'impatto è stato seguito da un gran numero di osservatori terrestri e nello spazio (\cref{fig:obs_dart}).\\
