...
\begin{table}[!h]
    ...
    \resizebox{\linewidth}{!}{%
      ...
      \end{tabular}}%
    \end{center}
    \caption{Riassunto dei principali parametri dinamici e morfologici pre-impatto del sistema di (65803) Didymos.}  
...
%Ringrazio tutta, nessunə esclusə (anche i bot che tutt'oggi continuo a bannare), la Link4Universe Family per avermi accolto e permesso di maturare la mia passione per l'astrofisica, prima, e, negli ultimi anni, di poter raccontare alle persone quanto sono belle le cose che accadono nello spazio.
