...
\pdfinfo{%
  ...
  /Subject  (Ricerca bibliografica su asteroidi binari e il sistema di Didymos)
...
Al momento, quindi, non c'è un risultato certo sulla composizione dei due asteroidi. Quando saranno disponibili, nei prossimi mesi, queste informazioni, complementari a quelle fotometriche e radar, saranno essenziali per migliorare la comprensione del sistema e le conseguenze dell'impatto.
...
\begin{figure}
    ...
    \caption[Riassunto dei dati fotometrici utilizzati per determinare l'orbita post-impatto.]{Immagine scattata da LICIACube dopo il flyby con Dimorphos. Ogni riquadro rappresenta un diverso livello di contrasto per mettere in risalto la struttura fine dei pennacchi di detriti. Studiando questi pennacchi si sarà in grado di approfondire le conoscenze sugli asteroidi e i processi di impatto. (ASI/NASA/APL)}
...
\begin{figure}
    ...
    \caption[Immagine della cosa di detriti scattata da HST.]{Immagine scattata dal telescopio spaziale Hubble l'8 ottobre 2022. Si nota chiaramente la cosa di detriti che si estende per più di 10000 km. (NASA/ESA/STScI/HST)}
    \label{fig:hst_plume}
\end{figure}
