...
\Language{it}
\Subject{Lo scopo di questa tesi è quello di descrivere la missione DART al sistema asteroidale binario Didymos. Per fare questo si parte da una descrizione generale degli asteroidi per poi passare ai sistemi binari. La trattazione si sposterà poi sulle modalità e le finalità della missione DART. Verrà analizzato il sistema di (65803) Didymos. Infine, verranno descritti i primi risultati prodotti dalle campagne osservative, terrestri e spaziali, iniziate subito dopo l'impatto della sonda con l'asteroide Dimorphos.}
\Keywords{DART\sep Didymos\sep Dimorphos\sep spettroscopia\sep fotometria\sep periodo\sep composizione\sep PHA\sep impatto}
\end{filecontents*}
...
\pdfinfo{%
  /Title    (La missione DART al sistema binario Didymos)
  /Author   (Gabriele Bertinelli)
  /Subject  (Lo scopo di questa tesi è quello di descrivere la missione DART al sistema asteroidale binario Didymos. Per fare questo si parte da una descrizione generale degli asteroidi per poi passare ai sistemi binari, importanti obiettivi scientifici per studiare la formazione e l'evoluzione degli asteroidi e far luce sugli aspetti evolutivi del Sistema Solare stesso.)
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.75\textwidth]{figure/ifu_jwst.png}
...
%Il valore osservato della deriva quadratica (\textit{quadratic drift}) nell'anomalia media è $\Delta M_d=0.15\pm 0.14\; deg\,yr^{-2}$. Esprimendo $\Delta M_d$ in termini del semiasse maggiore dell'orbita mutua $a$, $\Delta M_d=-\frac{3n\dot{a}}{4a}$, 
...
\begin{table}[!h]
    ...
    \resizebox{\linewidth}{!}{%
      ...
      Deriva del semiasse maggiore & $\dot{a}$ $(cm\,\, yr^{-1})$ & $-0.09\pm 0.08$ \\
      ...
      \end{tabular}}%
    \end{center}
    \caption{Riassunto dei principali parametri dinamici, morfologici e spettroscopici pre-impatto del sistema di (65803) Didymos.}  
...
La prima persona che devo ringraziare è me stesso per avercela sempre messa tutta per portare a termine questa prima tappa di un lungo percorso univeritario.

Grazie alla mia famiglia, mamma Enrica, papà Luca, Rebecca, Vittoria, Filippo e Silvia, per avermi sempre sostenuto nelle mie scelte, per avermi permesso di costruire un pezzetto del mio futuro, per il loro costante affetto e per la perenne fiducia nelle mie potenzialità, anche quando io stesso non ne avevo.

Ringrazio l3 amici e l3 compagn3 di università per la compagnia e gli aiuti ricevuti durante questo percorso.

Ringrazio l3 amic3, che sono rimast3 a Brescia, per le risate su Discord o davanti a una birra e per esserci sempre stati ogniqualvolta tornavo in patria.

Ringrazio tutta, nessunə esclusə (anche i bot che tutt'oggi continuo a bannare), la famiglia di Link4Universe per avermi accolto e permesso di maturare la mia passione per l'astrofisica e per avermi dato la possibilità raccontare alle persone quanto sono belle le cose che accadono nello spazio.

\textit{Addio, e grazie per tutto il pesce!}

\hspace{0pt}
\vfill
\begin{center}
E tu dove vai a ballare?\\ 
Scoprilo scannerizzando il QR code
\end{center}
\begin{figure*}[!h]
   \centering
   \includegraphics[scale=0.05]{figure/qr_code.png}
   \label{fig:qr_code}
\end{figure*}
\vfill
\hspace{0pt}
